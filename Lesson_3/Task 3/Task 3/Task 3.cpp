...
int main()
{
    ...
    int arr1[] = {
        19,14,22,22,17,22,13,21,20,24,18,10,17,16,17,20,22,11,20,16,
    ...
    int arr3[] = {
        21,15,19,18,23,12,18,18,19,23,12,20,15,22,21,18,19,20,12,16,
        20,14,17,13,10,23,19,14,10,22,19,12,24,23,22,15,13,22,18,18,
        11,23,24,17,10
    };
    int size3 = 45;
